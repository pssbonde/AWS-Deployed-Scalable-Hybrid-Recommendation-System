...
st.markdown('<div class="big-title">🎧 Content Based Music Recommender</div>', unsafe_allow_html=True)
...
if st.button("🔁 Get Recommendations"):
    if (data["name"].str.lower() == song_name).any():
        ...
        recommendations = get_content_based_recommendations(song_name, data, transformed_data, k)
